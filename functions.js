...
export let owner = ["6282135250846@s.whatsapp.net", "6285640020165@s.whatsapp.net", "628812904283@s.whatsapp.net", "6285727199558@s.whatsapp.net"];
...
export const pino = P({                                   //|
    ...
    prettyPrint: {                                        //|
        ...
        customPrettifiers: {                              //|
          time: time => moment.tz("Asia/Jakarta").format("HH:mm:ss"),                                        //|
          level: level => pinoLevel(level)                //|
        }                                                 //|
    }                                                     //|
})                                                        //|
//--------------------------------------------------------//|
